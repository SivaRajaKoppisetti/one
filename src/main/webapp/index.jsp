...
<body>
    ...
    <header>
        ...
        <!-- mobile menu -->
        <div id="mobileMenu" style="display:none; background:white; border-top:1px solid #eef3fc; padding:12px 24px;">
        ...
        <!-- search (moved inside header for better UX) -->
    ...
    <main>
        ...
        <section class="hero">
            <div class="container hero-content">
                <h1>New arrivals · <br>winter collection</h1>
        ...
        <section class="section container" id="testimonials">
            ...
            <div class="testimonials-scroll" id="testimonialsContainer">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="avatar-row">
                        <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=80&q=80" alt="Sophia">
